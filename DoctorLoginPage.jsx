      ...
      <div className="booking-form" style={{ width: '100%', borderTop: '4px solid #10b981' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group" style={{ marginBottom: 18 }}>
            ...
            <input type="email" name="email" autoComplete="new-email" className="input" placeholder="doctor@medicare.com" value={form.email} onChange={handleChange} required />
          </div>

          <div className="form-group" style={{ marginBottom: 28 }}>
            <label>Password</label>
            <input type="password" name="password" autoComplete="new-password" className="input" placeholder="******" value={form.password} onChange={handleChange} required />
          </div>
